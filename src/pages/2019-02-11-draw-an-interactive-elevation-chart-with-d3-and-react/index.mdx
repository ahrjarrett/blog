...
<React.Fragment>
  <h5 id="asterisk1" className="asterisk-body">
    ...
    like “canvas” evokes; _lens_ might be a more appropriate metaphor. Certainly
    that the dynamic of our relationship with mapping software could be
    pessimistically summarized as a sequence of Ouija board manipulations that
    either translate or dilate our aperture onto a model that we drew up to
    ...
    anthropological significance, as artifact become tool again.
  </h5>
</React.Fragment>
